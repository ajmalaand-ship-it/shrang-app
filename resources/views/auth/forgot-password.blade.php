...
<head>
    ...
    <title>Reset Password — Shrang</title>
...
<body>
    <div class="auth-card">
        ...
        <p class="auth-sub">Enter your email and we will send a reset link</p>
        ...
        <p class="auth-link"><a href="{{ route('login') }}">Back to log in</a></p>
    </div>
</body>
</html>
